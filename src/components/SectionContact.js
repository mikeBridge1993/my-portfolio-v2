    ...
    <div className="contact-box">
      <form method="POST" action="https://formspree.io/miguelponte93@hotmail.com" className="contact-form">
        <div className="contact-form__header">
          If you have any doubt or question and would like to get in touch,
          please feel free to reach me through any of the means below.
        </div>
        ...
        <div className="contact-form__text">
          ...
          <div className="contact-form__group">
            ...
            <textarea name="message" type="text" required className="contact-form__input" />
          </div>
        </div>
        <div className="mt-5 mb-5 pb-5">
          <button className="button button--primary" type="submit">Send Message</button>
          <a className="button button--primary mx-3" href="mailto:miguelponte93@hotmail.com"><i className="fa fa-envelope-o" /></a>
          <a className="button button--primary" href="https://www.linkedin.com/in/miguelsmponte/"><i className="fab fa-linkedin-in" /></a>
        </div>
