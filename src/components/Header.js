  ...
  <header>
    <nav className="navbar navbar-expand-md navbar-dark">
      <div className="nav-header">
        <Link exact className="navbar-brand" to="/">M<span>P</span></Link>
        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
          <input type="checkbox" className="checkbox" id="navi-toggle" />
          <label htmlFor="navi-toggle" className="checkbox__button">
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ml-auto">
          <li className="nav-item">
            <Link exact activeStyle={activeStyle} className="nav-link active" to="/">Home</Link>
          </li>
          <li className="nav-item">
